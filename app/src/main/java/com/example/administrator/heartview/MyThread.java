package com.example.administrator.heartview;
...
import com.example.administrator.ustc_health.MyInforFragment;
import com.example.administrator.ustc_health.MyhealthActivity;
...
public class MyThread extends Thread {
    ...
    @Override
    public void run() {
        int totalScore =Integer.valueOf(MyInforFragment.str01);
